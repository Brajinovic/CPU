...
synth_design -top bit1Comparator -part xc7s100fgga676-2
...
write_checkpoint -force -noxdef bit1Comparator.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file bit1Comparator_utilization_synth.rpt -pb bit1Comparator_utilization_synth.pb"
